...
export const Overview = () => {
  ...
  return (
    <Section background="constellations" goop={2}>
      <ThisContent>
        <ThisText>
          <ThisTagline>The community platform for all universities.</ThisTagline>
          ...
          <ThisCopy>
            Kampus makes it easy to grow safe, successful online universities communities
    ...
    <Section goop={6} color={'space.alt'}>
      <ThisContent>
        ...
        <Text>
          ...
          <ThisCopy>
            By building on Kampus, communities become easily discoverable
            through search, curation, and even other community members.
          </ThisCopy>
          <ThisCopy>
            It also means no more managing multiple logins or playing
            whack-a-mole with different notifications and preferences.
          </ThisCopy>
          <Actions>
            <ThisPrimaryCTA
              to="/explore"
  ...
  return (
    <Section goop={4} background="bright">
      <ThisContent>
        ...
        <ThisCopy>
          Try searching for topics like “Exams” or for courses like “MA101”!
        </ThisCopy>
        <Search />
      </ThisContent>
    </Section>
    ...
    <Section goop={7} color={'bg.reverse'}>
      <ThisContent>
        ...
        <FlexCol>
          ...
          <ThisCopy>
            Conversations on Kampus are real-time chat, just like your
            favorite messaging app. But on Kampus, conversations continue to
...
export const Sell = () => {
  ...
  return (
    <ThisSection goop={2} background="dark" color={'bg.reverse'}>
      <ThisContent>
        <Text>
          <ThisTagline>Kampus saves you time and money</ThisTagline>
          <Bullets>
            <Bullet>
              <BulletHeading>
              ...
              <BulletCopy>
                Now your students can have conversations with you and each other. users can chat privately when a particular issue is sensitive.
              </BulletCopy>
            </Bullet>
            <Bullet>
              <BulletHeading>
              ...
              <BulletCopy>
              Kampus gives your students a place to
            ...
            <Bullet>
              ...
              <BulletCopy>
                Think of kampus as a new direct line to discovering what your
                university wants the most.
              </BulletCopy>
            </Bullet>
          </Bullets>
        </Text>
...
export const Yours = () => {
  ...
  return (
    <Section goop={0} background={'reverse'}>
      <ThisContent>
        <FlexCol>
          <ThisTagline>You’re gonna love Kampus.</ThisTagline>
          <Quotes>
            <Quote>
              <Rule>
                <hr />
              ...
              <Pullquote>
                okay, honestly Kampus is the best thing that happened to me
                regarding how to manage my class in the digital era
              </Pullquote>
            ...
            <Quote>
              ...
              <Pullquote>
                Kampus will take the place that bilboard used to have a long
                time ago for communities (especially on campus) to freely share ideas
            ...
            <Quote>
              ...
              <Pullquote>
                Kampus is definitely a product worth looking out for. Huge fan
