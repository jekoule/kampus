          ...
          >
            ...
            <Subtitle>
              {brandedLogin.message && brandedLogin.message.length > 0
                ...
                : 'Kampus is a place where Academic communities can share, discuss, and grow together. Sign in below to get in on the conversation.'}
            </Subtitle>
            ...
            <CodeOfConduct>
              By using Kampus, you agree to our{' '}
              <a
                href="https://github.com/jekoule/kampus/code-of-conduct"
                target="_blank"
